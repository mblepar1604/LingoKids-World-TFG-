...
const SecuenciaSonidosHTML = ({ ronda, sonidos, handleClick, reiniciar }) => {
  return (
...
const SecuenciaSonidos = () => {
  ...
  const reiniciar = () => {
    ...
    setJugador([]);
    setRonda(1);
    setTimeout(() => iniciarNuevaRonda(), 500);
  };
  ...
  return <SecuenciaSonidosHTML ronda={ronda} sonidos={sonidos} handleClick={handleClick} reiniciar={reiniciar} />;
};
